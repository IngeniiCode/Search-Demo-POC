...
class SearchForm extends Form {
	...
	private function find(){
		$TEMPLATE = <<<TEMPLATE
<h3>I Want to Find:</h3>%s %s %s %s %s %s %s %s %s %s %s
TEMPLATE;
		$this->formHtml = sprintf($TEMPLATE,
			$this->hidden('type','find'),
			$this->hidden('mode','sss'),   //  'sss'  =  a very generic CL search
	...
	private function car(){
		$TEMPLATE = <<<TEMPLATE
<h3>Car Search</h3>%s %s %s %s %s %s %s %s %s %s %s
TEMPLATE;
		$this->formHtml = sprintf($TEMPLATE,
			$this->hidden('type','car'),
			$this->hidden('mode','cta'),
			$this->hiddenval('zonefilter'),
			$this->search_term_adv(array('ut'=>$this->USER['type'])),
			$this->saved_search(array('ut'=>$this->USER['type'])),
			'',//$this->search_vehicle_or_parts('cta','pta'),
	...
	// - - - - - - - - - - - - - - - - - - - - - -
	private function truck(){
		$TEMPLATE = <<<TEMPLATE
<h3>Truck Search</h3>%s %s %s %s %s %s %s %s %s %s %s
TEMPLATE;
		$this->formHtml = sprintf($TEMPLATE,
			$this->hidden('type','truck'),
			$this->hidden('mode','cta'),
			$this->hiddenval('zonefilter'),
			$this->search_term_adv(array('ut'=>$this->USER['type'])),
			$this->saved_search(array('ut'=>$this->USER['type'])),
	...
	// - - - - - - - - - - - - - - - - - - - - - -
	private function motorcycle(){
		$TEMPLATE = <<<TEMPLATE
<h3>Motorcycle Search</h3>%s %s %s %s %s %s %s %s %s %s %s
TEMPLATE;
		$this->formHtml = sprintf($TEMPLATE,
			$this->hidden('type','motorcycle'),
			$this->hidden('mode','mca'),
			$this->hiddenval('zonefilter'),
			$this->search_term_adv(array('ut'=>$this->USER['type'])),
			$this->saved_search(array('ut'=>$this->USER['type'])),
			'',//$this->search_vehicle_or_parts(),
			$this->price_range(),
			$this->search_years(),
			'',//$this->showmap(),
			$this->zoneselect(array('options'=>$this->ZONES)),
	...
	private function boat(){
		$TEMPLATE = <<<TEMPLATE
<h3>Marine Search</h3>%s %s %s %s %s %s %s %s %s
TEMPLATE;
		$this->formHtml = sprintf($TEMPLATE,
			$this->hidden('type','boat'),
			$this->hidden('mode','boo'),
			$this->hiddenval('zonefilter'),
			$this->search_term_adv(array('ut'=>$this->USER['type'])),
			$this->saved_search(array('ut'=>$this->USER['type'])),
			$this->price_range(),
